...
public class Lancamento {
	...
	public StatusLancamento getStauts() {
		return stauts;
	}

	public void setStauts(StatusLancamento stauts) {
		this.stauts = stauts;
	}

	@Override
	public int hashCode() {
		return Objects.hash(ano, dataCadastro, descricao, id, mes, stauts, tipo, usuario, valor);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(ano, other.ano) && Objects.equals(dataCadastro, other.dataCadastro)
				...
				&& Objects.equals(mes, other.mes) && stauts == other.stauts && tipo == other.tipo
	...
	public String toString() {
		return "Lancamento [id=" + id + ", descricao=" + descricao + ", mes=" + mes + ", ano=" + ano + ", usuario="
				+ usuario + ", valor=" + valor + ", dataCadastro=" + dataCadastro + ", tipo=" + tipo + ", stauts="
				+ stauts + "]";
	}
